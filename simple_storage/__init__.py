...
class FileStorage():
    """
    Класс должен предоставлять возможность хранить много файлов.
    Требования:
    1. быстрый доступ к файлам.
    2. хеш как индентификатор -> уникальность на уровне файловой системы
    3. Возможность удобно повязать файл к сущности
    4. интерфейс к обеспечению консистентности
       а) проверить есть ли файлы о которых база не знает
       б) проверить все ли файлы о которых знает база лежат на серваке
    """
